...
* The original package name 'ir.dotin.softwaresystems.library-management' is invalid and this project uses 'ir.dotin.softwaresystems.librarymanagement' instead.
